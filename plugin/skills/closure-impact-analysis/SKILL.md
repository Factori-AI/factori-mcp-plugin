...
- The verdict (Safe to close / Coverage gap / High customer loss) appears exactly once — in the first sentence of the report, embedded inline in plain prose. Example: "This is a safe closure, with the remaining network absorbing the majority of affected visitors."
...
- Evidence labels: bold inline, e.g. **Customers at Risk**.
...
First sentence of the report only. Format: "This is a [safe/coverage gap/high-loss] closure, [one clause of rationale]."
...
Standard KPIs for this skill (in order): Customers at risk · % retained · % lost to competitors · Coverage gap count
