...
- The winner per pillar and differentiation recommendation appear exactly once — in the first sentence of the report, embedded inline in plain prose. Example: "Your location holds a clear traffic advantage but faces a stronger catchment in the competitor's market — differentiate on audience quality."
...
- Evidence labels: bold inline, e.g. **Composite Scores per Pillar**.
...
First sentence of the report only. State the winner per pillar and the single most important strategic implication.
...
Standard KPIs for this skill (in order): Traffic advantage · Catchment size ratio · Market quality delta · Trend momentum winner
...
Final paragraph (no heading). Restate the competitive verdict in a sentence, then give the single most important next action.
