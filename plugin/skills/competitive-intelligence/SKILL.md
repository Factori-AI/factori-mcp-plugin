...
**PDF report title:**
- "Competitive Intelligence Report": 28pt bold white, left-aligned, in content flow
...
**Beat 1 — Verdict**
First sentence only. State who wins per pillar and the primary area to defend or differentiate in one sentence. No badge. No heading. No emoji.
...
Standard KPIs for this skill (in order): Traffic score (mine) · Traffic score (competitor) · Demographics score gap · Catchment size comparison · Trend momentum
...
1. Composite scores per pillar
2. Catchment comparison
3. Market-quality gap
4. Commercial-mix comparison
5. Trend momentum

Format per paragraph: **Bold label** → key number(s) → interpretation → one-line "so what" at the end.

**Beat 4 — Bottom line**
Final paragraph (no heading). Restate where to differentiate and where to defend, then give the single most important next action. If 3+ evidence blocks used fallback language, add: "Confidence is low — recommend re-running once data is available."
---
...
| | |
|---|---|
| **Verdict label** | Winner per pillar + where to defend/differentiate |
| **Evidence blocks (in order)** | Composite scores per pillar · Catchment comparison · Market-quality gap · Commercial-mix comparison · Trend momentum |
