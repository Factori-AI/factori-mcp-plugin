...
**Beat 1 — Verdict**
First sentence only. State the peak window and operating recommendation in one sentence. No badge. No heading. No emoji.
...
Standard KPIs for this skill (in order): Peak window · Morning device count · Daytime device count · Night device count · Late-night %
...
**Beat 4 — Bottom line**
Final paragraph (no heading). Restate the peak window and recommended operating hours, then give the single staffing/hours next action. If 3+ evidence blocks used fallback language, add: "Confidence is low — recommend re-running once data is available."
---
