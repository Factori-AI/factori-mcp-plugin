...
**PDF report title:**
- "Market Quality Report": 28pt bold white, left-aligned, in content flow
...
**Beat 1 — Verdict**
First sentence only. State Enter / Differentiate / Avoid and one-sentence rationale with the key saturation or opportunity metric. No badge. No heading. No emoji.
...
Standard KPIs for this skill (in order): Opportunity level · Avg rating · Vulnerable POI % · Branded % · Price-tier gap
...
1. Opportunity level + saturation
2. % vulnerable POIs
3. Branded vs independent mix
4. Price-tier gap

Format per paragraph: **Bold label** → key number(s) → interpretation → one-line "so what" at the end.

**Beat 4 — Bottom line**
Final paragraph (no heading). Restate Enter / Differentiate / Avoid and the single most important next action. If 3+ evidence blocks used fallback language, add: "Confidence is low — recommend re-running once data is available."
---
...
| | |
|---|---|
| **Verdict label** | Enter / Differentiate / Avoid |
| **Evidence blocks (in order)** | Opportunity level + saturation · % vulnerable POIs · Branded vs independent mix · Price-tier gap |
