...
- The draw type (hyper-local / commuter / regional) appears exactly once — in the first sentence of the report, embedded inline in plain prose. Example: "This is a regional draw pulling visitors from well beyond the immediate neighbourhood, with a broad multi-county catchment."
...
- Evidence labels: bold inline, e.g. **Top Origin Hexes**.
...
First sentence of the report only. Format: "This is a [hyper-local/commuter/regional] draw, [one clause of rationale]."
...
Standard KPIs for this skill (in order): Primary catchment radius · Top origin hex % · Visitor income tier · Peak visit window · Draw type
...
1. Top Origin Hexes
2. Primary (50%) & Secondary (80%) Catchment
...
Final paragraph (no heading). Restate the draw type in a sentence, then give the single most important next action.
